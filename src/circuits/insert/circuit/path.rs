...
use halo2_proofs::{arithmetic::Field, circuit::Value, pasta::group::ff::PrimeFieldBits};
...
impl<const N: usize> MerklePath<N> {
    ...
    pub(crate) fn make_pairs(&self, bits: RunningSum<Base>) -> Vec<(Base, Value<bool>)> {
